...
export default function Login({navigation}) {
   ...
   return (
      <View style={styles.mainContainer}>
         ...
         <Text style={{fontSize: 18, fontWeight: "500"}}>Connecte toi à ton compte Hopteo !</Text>
         
         <Text style={{textAlign: "center", color: Colors.orange500, marginBottom: "3%", marginTop: "3%", width: "75%"}}>
            {loginErrorMessage}
            </Text>
         ...
         <View style={styles.formContainer}>
            ...
            <TouchableOpacity style={{marginTop: "10%"}} onPress={onNewAccountPress}>
            <Text style={{textAlign: "center"}}>{"Nouveau.elle sur Hopteo ?\nCréer mon compte"}</Text>
            </TouchableOpacity>
         </View>
      </View>
   );
