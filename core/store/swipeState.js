export const initialSwipeState = {
  ...
  idCardsList: [],          // [ingeCard1, ingeCard2, ingeCard3, ingeCard4, ingeCard5, ...]   liste totale des cartes pour l'utilisateur
  sentToBackAnswers: [],    // [ingeCard1, ingeCard2]
  notSentToBackAnswers: [], // [ingeCard3]
  removedIdStillInBackEnd:  [], //should not be empty if notSentToBackAnswers is so and undoSwipe is pressed (example : [ingeCard3])
